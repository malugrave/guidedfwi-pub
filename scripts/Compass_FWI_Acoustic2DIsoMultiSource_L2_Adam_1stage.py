"""
Description:
Acoustic 2D Multi-source Isotropic Full Waveform Inversion on the Compass model.
...
export DEVITO_LANGUAGE=openmp; export DEVITO_MPI=0; export OMP_NUM_THREADS=4; export MKL_NUM_THREADS=4; export NUMBA_NUM_THREADS=4; mpiexec -n 16 python Compass_FWI_Acoustic2DIsoMultiSource_L2_Adam_1stage.py
...
results_folder = (
    '../results/Compass_FWI_Acoustic2DIsoMultiSource_'+str(run_id)
)
...
for fi, freq in enumerate(freqs):
    ...
    ainv = AcousticWave2D(shape, origin, spacing, 
        ...
        source_encoding='random_time_delay',
        base_comm=comm,
    ...
    if rank == 0:
        plot_modulus(direction.reshape(vp_true.shape).T/scaling, aspect='auto', 
