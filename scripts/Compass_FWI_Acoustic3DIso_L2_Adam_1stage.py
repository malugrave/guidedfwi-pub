"""
Description:
Acoustic 3D Isotropic Full Waveform Inversion on the Compass model.
...
export DEVITO_LANGUAGE=openmp; export DEVITO_MPI=0; export OMP_NUM_THREADS=56; export MKL_NUM_THREADS=56; export NUMBA_NUM_THREADS=56; mpiexec -n 2 python Compass_FWI_Acoustic3DIso_L2_Adam_1stage.py
...
def main():
    ...
    results_folder = (
        '../results/Compass_FWI_Acoustic3DIso_'+str(run_id)
    )
    ...
    for fi, freq in enumerate(freqs):
        ...
        if rank == 0:
            plot_slices(direction.T/scaling, aspect='auto', 
