...
from video_diffusion_pytorch.video_diffusion_pytorch import EMA, cycle, noop, exists, num_to_groups, video_tensor_to_gif
...
from .utils import NumpyCubeDataset
    ...
    def __init__(
        ...
        *,
        ...
        if folder is not None:
            self.ds = NumpyCubeDataset(file_path=folder, cube_size=cube_size)
            ...
            for i in range(self.gradient_accumulate_every):
                ...
                with autocast(enabled = self.amp):
                    loss = self.model(
                        ...
                        focus_present_mask = focus_present_mask, **kwargs
                    )
