...
class PostProcessX():
    ...
    :func:`acoustic2disokernel.AcousticWave2D` propagator. More specifically:
    ...
    """
    def __init__(self, scaling=1., sigmas=None, mask=None, scale_loss=True, minus_grad=True):
        self.scaling = scaling
        self.sigmas = sigmas
        self.mask = mask
        self.scale_loss = scale_loss
        self.minus_grad = minus_grad
